...
insert into Hotel_Services (ServiceId, ServiceName, Price) values 
(1, 'Room Cleaning', 500.00),
(2, 'Laundry Service', 300.00),
(3, 'Spa Treatment', 1500.00),
(4, 'Special Lunch Booking', 800.00),
(5, 'Breakfast', 250.00);
...
(3, 'Kolhapur', 'Mahalakshmi Temple, Rankala Lake, Mountans,Kolhapur'),
...
select dbo.fn_CalculateTotalDays(2);



--7. Triggers 
-- Trigger to Booking Room. Check the room is Available or not.
...
insert into Hotel_Bookings (CustomerId, RoomId, CheckInDate, CheckOutDate, TotalAmount) values
(1, 101, '2025-02-25', '2025-02-27', 2000.00);
...
select * from Hotel_HotelBranch
where contains(LocationDecription, 'Mumbai');
